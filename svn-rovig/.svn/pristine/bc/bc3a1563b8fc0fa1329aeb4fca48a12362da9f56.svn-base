...
% plot(log10(resSquare{1}),'-b*','LineWidth',5,'MarkerSize',40);
% plot(log10(resSquare{2}),'-g*','LineWidth',5,'MarkerSize',30);
% plot(log10(resSquare{3}),'-r*','LineWidth',5,'MarkerSize',30);
% plot(log10(resSquare{4}),'-bo','LineWidth',5,'MarkerSize',40);
...
plot(log10(resSquare{5}),'-bo','LineWidth',5,'MarkerSize',40);
...
set(gca,'fontsize',60)
title('C_{eq}=1e2, C_{compl}=1e1, Dofs=47382')
...
% plot((rate{1}),'-b*','LineWidth',5,'MarkerSize',40);
% plot((rate{2}),'-g*','LineWidth',5,'MarkerSize',30);
% plot((rate{3}),'-r*','LineWidth',5,'MarkerSize',30);
% plot((rate{4}),'-bo','LineWidth',5,'MarkerSize',40);
...
plot((rate{5}),'-bo','LineWidth',5,'MarkerSize',40);
