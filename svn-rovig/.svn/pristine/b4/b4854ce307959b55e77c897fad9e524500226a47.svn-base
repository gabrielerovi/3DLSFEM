...
parameters =parameters_lambda1smoothing3();
...
save( fullfile( pwd,ffname{4},'activesetlambda1smoothing3.mat'), 'activeset')
save( fullfile( pwd,ffname{5},'isitlinearlambda1smoothing3.mat'), 'isitlinear')
save( fullfile( pwd,ffname{1},'xlambda1smoothing3.mat'), 'x')
...
save( fullfile( pwd,ffname{3},'residuallambda1smoothing3.mat'), 'residual')


string1=stringtype;
string1=strcat(string1,string0,'sol/Solutionlambda');
string=strcat(string1,stringext);
save( fullfile( pwd,ffname{2},'sollambda1smoothing3.mat'), 'sol')
