function M=assembling_A11(qrule,node,edge_per_elem,alpha,beta,coeff_equilibrium,coeff_constitutive,coeff_symmetry,input_name)
   ...
   for e1=1:edge_per_elem    
        for e2=1:edge_per_elem
            ...
            for qp=1:number_of_qp
                ...
                value(qp)= weights(qp)* ...
                    (coeff_symmetry * RT0{e1}(qp,2) * RT0{e2}(qp,2) + ...
                     coeff_constitutive * C1 * RT0{e1}(qp,2)* RT0{e2}(qp,2) + ...
                     coeff_constitutive * C2 * RT0{e1}(qp,1)* RT0{e2}(qp,1) + ... 
                 ...
                 intxye2=0;
                 for qp=1:number_of_qp
                     intxye1=weights(qp)*RT0{e1}(qp,2);
                     intxye2=weights(qp)*RT0{e2}(qp,2);
                 end
