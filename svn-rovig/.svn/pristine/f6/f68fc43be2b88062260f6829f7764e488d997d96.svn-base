...
mesh =create_meshes_coarser_to_finer(mesh,number_of_levels,dim,N_components,E_components,F_components);
mesh=node_and_edge_normal_boundary(mesh,parameters);
