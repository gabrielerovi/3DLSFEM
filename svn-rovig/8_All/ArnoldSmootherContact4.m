...
function [x,Constraint]=ArnoldSmootherContact4(x,b,mesh,Ant,Constraint,smoothing_steps,is_on_coarser_grid,graph,top2bottom,maps)
...
for kk=1:length(E_contact)
    ...
    N_contact_Loc=mesh.N_contact_map(nn);
...
mesh_Loc.N_contact=N_loc_map(nn);
...
Constraint_Loc.CheckConstraintE1=Constraint.CheckConstraintE1(E_contact_Loc,Tot_InternalGlobContact);
Constraint_Loc.RhsE1=Constraint.RhsE1(E_contact_Loc,1);
Constraint_Loc.CheckConstraintN1=Constraint.CheckConstraintN1(N_contact_Loc,Tot_InternalGlobContact);
Constraint_Loc.RhsN1=Constraint.RhsN1(N_contact_Loc,1);
Constraint_Loc.CheckConstraintE2=Constraint.CheckConstraintE2(E_contact_Loc,Tot_InternalGlobContact);
Constraint_Loc.RhsE2=Constraint.RhsE2(E_contact_Loc,1);
Constraint_Loc.CheckConstraintN2=Constraint.CheckConstraintN2(N_contact_Loc,Tot_InternalGlobContact);
Constraint_Loc.RhsN2=Constraint.RhsN2(N_contact_Loc,1);
...
mapping_loc=1:2*mesh_Loc.NE;
ii=mesh_Loc.N_contact;
mapping_loc=[mapping_loc,2*mesh_Loc.NE+ii,2*mesh_Loc.NE+ii+length(N_contact)];
...
mesh_Loc.N_contact=1;
    ...
    [x_Loc,is_the_right_solution,Constraint_Loc] = activeset4(A_Loc,b_Loc,Constraint_Loc,mesh_Loc,actual_solution,mapping_loc);
    end
