function [Patch_Edge,Patch_Node,Patch_Boundary_Edge,Patch_Boundary_Node,EmapLoc2Glob,EmapGlob2Loc,NmapLoc2Glob,NmapGlob2Loc]=Arnold_patch2(mesh)

% HERE A BOUNDARY PATCH CONTAINS ALL THE EDGES ADJACENT TO A NODE,
% REGARDLESS IF IT IS ON THE BOUNDARY OR NOT
L=size(mesh);
L=L(1);
