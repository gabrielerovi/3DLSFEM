function x =v_cycle_hybridREORDER(components,lev,A_lev,b,x,C_lev,RTCtoRTF,NDtoRT,smoothing_steps,mesh)
if(lev==1)
    x=A_lev{1}\b;
else
    %pre-smoothing
    x=gauss_seidel_hybridREORDER(components,A_lev{lev},b,x,NDtoRT{lev},C_lev{lev},smoothing_steps,mesh{lev})   ;
