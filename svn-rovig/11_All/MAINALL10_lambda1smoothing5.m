...
parameters =parameters_lambda1smoothing5();
...
save( fullfile( pwd,ffname{4},'activesetlambda1smoothing5.mat'), 'activeset')
save( fullfile( pwd,ffname{5},'isitlinearlambda1smoothing5.mat'), 'isitlinear')
save( fullfile( pwd,ffname{1},'xlambda1smoothing5.mat'), 'x')
...
save( fullfile( pwd,ffname{3},'residuallambda1smoothing5.mat'), 'residual')


string1=stringtype;
string1=strcat(string1,string0,'sol/Solutionlambda');
string=strcat(string1,stringext);
save( fullfile( pwd,ffname{2},'sollambda1smoothing5.mat'), 'sol')
