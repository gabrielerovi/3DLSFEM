function [x,WorkingSet,norm_res] = ArnoldVcycleContact3DAugmented(A,Complementarity,b,x,h,Constraint,WorkingSet,smoothing_steps,mesh_parameters,graph,Pnt,maxlev,lev)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%%%% Lev>1: pre-smoothing %%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    [x,WorkingSet]=ArnoldSmootherContactAugmented(WorkingSet,Abc,x,b,Constraint,flip_vector(graph{F},0),mesh_parameters{F}.N_contact,mesh_parameters{F}.Patch_Internal_All,smoothing_steps) ;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    [corrC,WorkingSetC] = ArnoldVcycleContact3DAugmented(ACnobc,ComplementarityC,resC,corrC,h,ConstraintC,WorkingSetC,smoothing_steps,mesh_parameters,graph,Pnt,maxlev,C);
     corrF=P*corrC;
     corrF(RemoveF)=0;    
      x=x+corrF;
    ...
    %%%%%% Lev>1: pre-smoothing %%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [x,WorkingSet]=ArnoldSmootherContactAugmented(WorkingSet,Abc,x,b,Constraint,flip_vector(graph{F},1),mesh_parameters{F}.N_contact,mesh_parameters{F}.Patch_Internal_All,smoothing_steps) ;
end
