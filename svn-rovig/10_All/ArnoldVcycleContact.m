function [x,WorkingSet,norm_res] = ArnoldVcycleContact(A,Complementarity,b,x,h,Constraint,WorkingSet,smoothing_steps,mesh_parameters,graph,Pnt,maxlev,lev)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    ConstraintC= ArnoldCoarseConstraint(ConstraintF,mp);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    [corrC,WorkingSetC] = ArnoldVcycleContact(ACnobc,ComplementarityC,resC,corrC,h,ConstraintC,WorkingSetC,smoothing_steps,mesh_parameters,graph,Pnt,maxlev,C);
     corrF=P*corrC;
     corrF(RemoveF)=0;    
     x=x+corrF;
