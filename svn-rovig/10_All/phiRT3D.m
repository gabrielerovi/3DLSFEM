...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%              
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%              
                ...
                RT0_XGradX=[]; RT0_XGradY=[]; RT0_XGradZ=[];
                RT0_YGradX=[]; RT0_YGradY=[]; RT0_YGradZ=[];
                RT0_ZGradX=[]; RT0_ZGradY=[]; RT0_ZGradZ=[];
                
                
                for ii=1:length(RT0_X)
                    RT0_XGradX=[RT0_XGradX;P1grad(:,1).*RT0_X(ii)]; RT0_XGradY=[RT0_XGradY;P1grad(:,2).*RT0_X(ii)]; RT0_XGradZ=[RT0_XGradZ;P1grad(:,3).*RT0_X(ii)];
                    RT0_YGradX=[RT0_YGradX;P1grad(:,1).*RT0_Y(ii)]; RT0_YGradY=[RT0_YGradY;P1grad(:,2).*RT0_Y(ii)]; RT0_YGradZ=[RT0_YGradZ;P1grad(:,3).*RT0_Y(ii)];
                    RT0_ZGradX=[RT0_ZGradX;P1grad(:,1).*RT0_Z(ii)]; RT0_ZGradY=[RT0_ZGradY;P1grad(:,2).*RT0_Z(ii)]; RT0_ZGradZ=[RT0_ZGradZ;P1grad(:,3).*RT0_Z(ii)];
...
%                 
%                 norm(RT0_XGradX-RT0_XGradX1)
%                 norm(RT0_XGradY-RT0_XGradY1)
%                 norm(RT0_XGradZ-RT0_XGradZ1)
%                 
%                 norm(RT0_YGradX-RT0_YGradX1)
%                 norm(RT0_YGradY-RT0_YGradY1)
%                 norm(RT0_YGradZ-RT0_YGradZ1)
%                 
%                 norm(RT0_ZGradX-RT0_ZGradX1)
%                 norm(RT0_ZGradY-RT0_ZGradY1)
%                 norm(RT0_ZGradZ-RT0_ZGradZ1)
