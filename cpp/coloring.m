...
text(center(1),center(2),txt)
        ...
        elseif(A(ii,3)==7)
        plot(center(1),center(2),'o','MarkerSize', 20,'MarkerEdgeColor','y','LineWidth',4);
        elseif(A(ii,3)==8)
        plot(center(1),center(2),'o','MarkerSize', 20,'MarkerEdgeColor','g','LineWidth',4);
        elseif(A(ii,3)==9)
        plot(center(1),center(2),'o','MarkerSize', 20,'MarkerEdgeColor','b','LineWidth',4);
        elseif(A(ii,3)==10)
        plot(center(1),center(2),'o','MarkerSize', 20,'MarkerEdgeColor','k','LineWidth',4);
        elseif(A(ii,3)==11)
